...
global.email = "anthonyodan01@gmail.com";
global.location = "Agbado,Ogun,state.";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "Odan",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "DARK RAIDER-𝐌𝐃-𝐕2",
